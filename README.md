...
This repository is the @metabrainz fork of https://github.com/reactiflux/discord-irc. Make all the changes on the production
or any other branch, the main should be kept clean to allow seamless syncing with the main repo.
